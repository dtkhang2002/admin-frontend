  ...
  try {
    ...
    if (password.value !== confirmPassword.value) {
      toast.add({
        severity: "error",
        summary: "Đăng ký",
        detail: "Đăng ký người dùng mới thất bại, mật khẩu xác nhận không khớp",
        life: 3000,
      });
      return;
    }
    ...
    toast.add({
      severity: "success",
      summary: "Đăng ký",
      detail: "Đăng ký người dùng mới thành công",
      life: 3000,
    });
    router.push("/login");
  } catch (e) {
    toast.add({
      severity: "error",
      summary: "Đăng ký",
      detail: "Đăng ký người dùng mới thất bại, email đã tồn tại",
      life: 3000,
    });
  }
};
    ...
    <div class="login-content">
      <form @submit.prevent="register">
        ...
        <router-link to="/login"
          >Đã có tài khoản, đăng nhập tại đây</router-link
        >
      </form>
    </div>
  </div>
