  ...
  if (
    ...
    try {
      ...
      toast.add({
        severity: "error",
        summary: "Đổi mật khẩu",
        detail: "Đổi mật khẩu thất bại, mật khẩu hiện tại không đúng",
        life: 3000,
      });
      return;
    }
    ...
    >
      <div class="field">
        ...
        <InputText
          id="current_password"
          type="password"
          v-model.trim="userUpdate.current_password"
          required="true"
          autofocus
          :class="{ 'p-invalid': submitted && !userUpdate.current_password }"
        />
        <small class="p-error" v-if="submitted && !userUpdate.current_password"
          >Mật khẩu hiện tại là bắt buộc.</small
        >
      </div>
      <div class="field">
        ...
        <InputText
          id="new_password"
          type="password"
          v-model.trim="userUpdate.new_password"
          required="true"
          autofocus
          :class="{ 'p-invalid': submitted && !userUpdate.new_password }"
        />
        <small class="p-error" v-if="submitted && !userUpdate.new_password"
          >Mật khẩu mới là bắt buộc.</small
        >
      </div>
      <div class="field">
        ...
        <InputText
          id="confirm_password"
          type="password"
          v-model.trim="userUpdate.confirm_password"
          required="true"
          autofocus
          :class="{ 'p-invalid': submitted && !userUpdate.confirm_password }"
        />
        <small class="p-error" v-if="submitted && !userUpdate.confirm_password"
          >Mật khẩu xác nhận là bắt buộc.</small
        >
      </div>
      <template #footer>
        <Toast />
