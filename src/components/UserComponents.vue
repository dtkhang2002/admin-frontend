...
<template>
  <div>
    <div class="card">
      ...
      <DataTable
        ref="dt"
        :value="userStore.getListUser"
        dataKey="id"
        responsiveLayout="scroll"
        :paginator="true"
        :rows="userStore.getPageSize"
        :totalRecords="userStore.getTotalRecord"
      ...
      >
        ...
        <Column field="role_name" header="Vai trò" style="width: 5%">
          <template #body="slotProps">
            <span
              :style="{
                color: slotProps.data.role_name === 'ADMIN' ? 'red' : 'green',
              }"
            >
    ...
    >
      ...
      <div class="field">
        ...
        />
        <small class="p-error" v-if="submitted && !user.full_name"
          >Họ và tên bắt buộc.</small
        >
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <InputText
          ...
          :class="{ 'p-invalid': submitted && !user.email }"
        />
        <small class="p-error" v-if="submitted && !user.confirm_password"
          >Xác nhận mật khẩu bắt buộc.</small
        >
      </div>
      <div class="field">
        ...
        <Dropdown
          ...
          class="w-20rem"
        />
        <small class="p-error" v-if="submitted && !user.role_id"
          >Vai trò bắt buộc.</small
        >
      </div>
      <template #footer>
        <Toast />
    ...
    >
      <div class="confirmation-content">
        ...
        <span v-if="user"
          >Bạn có chắc bạn muốn xóa người dùng có email là
          <b>{{ user.email }}</b
          >?</span
        >
      </div>
